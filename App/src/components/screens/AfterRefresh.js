...
class AfterRefresh extends Component {
	...
	render(){
		...
		const addIconColor1 = this.state.added1 ? "rgb(252,61,57)" : null;
		const addIconColor2 = this.state.added2 ? "rgb(252,61,57)" : null;
		...
		return(
			...
			<View style={{ flex: 1, width: 100 + "%", height: 100 + "%"}}>
				...
				<View style={styles.journalBar} >
					<View style={{ flexDirection: "row", alignItems:"center"}}>
						<Image
							...
							source={config.copyright.oxford} 
						/>
						<Text style={{marginLeft: 5, marginRight: 125,fontWeight: 'bold'}}>Oxford Academic</Text>
						...
						>
						<Image
							style={[styles.journalPicRight, {tintColor: addIconColor1}]}
				...
				<View style={{
					...
					<Text style={{marginTop:3, fontWeight: 'bold', marginLeft: 5, marginRight: 5, fontSize: 12}}>Impaired Eye Movements In Post-Concussion Syndrome Indicate Suboptimal Brain Function Beyond The Influence Of Depression, Malingering Or Intellectual Ability</Text>
					<Text style ={{marginTop: 2, marginLeft: 5, marginRight: 5, fontSize: 12, marginBottom: 2}}>Post-concussion syndrome (PCS) can affect up to 20%–30% of patients with mild closed head injury (mCHI), comprising incomplete recovery and debilitating persistence of post-concussional symptoms. Eye movements relate closely to the functional integrity of the injured brain and eye movement function is impaired post-acutely in mCHI. Here, we examined whether PCS..</Text>
				</View>
				...
				<View style={styles.journalBar} >
					<View style={{ flexDirection: "row", alignItems:"center"}}>
						<Image
							style={styles.journalPicLeft}
							source={config.copyright.sr} 
						/>
						<Text style={{marginLeft: 5, marginRight: 120,fontWeight: 'bold'}}>Scientific Reports</Text>
						...
						>
						<Image
							style={[styles.journalPicRight, {tintColor: addIconColor2}]}
							source={config.images.heartIcon} 
						/>
						</TouchableOpacity>
						</View>
				...
				<View style={{
					...
					<Text style={{marginTop:3, fontWeight: 'bold', marginLeft: 5, marginRight: 5, fontSize: 12}}>Neuroimaging Of Sport Concussion: Persistent Alterations In Brain Structure And Function At Medical Clearance</Text>
					<Text style ={{marginTop: 2, marginLeft: 5, marginRight: 5, fontSize: 12, marginBottom: 2}}>The medical decision of return to play (RTP) after a sport concussion is largely based on symptom status following a graded exercise protocol. However, it is currently unknown how objective markers of brain structure and function relate to clinical recovery. The goal of this study was to determine whether differences in brain structure and function at acute injury...</Text>
				</View>
